...
class CustomObjectDumpTestCase(TestCase):
    ...
    def test_serialization(self):
        ...
        ar1_output = '[{"pk": 1, "model": "simpleapp.author", "fields": {"name": "Obi Wan"}}, {"pk": 1, "model": "simpleapp.authorprofile", "fields": {"date_of_birth": "1970-01-01"}}, {"pk": 1, "model": "simpleapp.category", "fields": {"name": "World"}}, {"pk": 1, "model": "simpleapp.tag", "fields": {"name": "Star"}}, {"pk": 2, "model": "simpleapp.tag", "fields": {"name": "War"}}, {"pk": 1, "model": "simpleapp.taggedarticle", "fields": {"headline": "Stars at war", "pub_date": "2013-01-01T12:00:00Z", "categories": [1], "author": 1}}, {"pk": 1, "model": "simpleapp.taggeditem", "fields": {"tag": 1, "object_id": 1, "content_type": 13}}, {"pk": 2, "model": "simpleapp.taggeditem", "fields": {"tag": 2, "object_id": 1, "content_type": 13}}]'
